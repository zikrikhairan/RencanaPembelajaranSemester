...
?>
            ...
            <div class="content-wrapper">
                <div class="login-logo">
                    Selamat Datang, <?php echo $this->session->userdata('nama'); ?> di <br>Sistem Informasi Rencana Pembelajaran Semester <br> Universitas Andalas <br>
                    <img src="<?php echo base_url('assets/img/unand2.png'); ?>" width="30%" height="30%">
                </div>
