        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <div class="box">
                    ...
                    <form method="POST" action ="<?php echo base_url().'isirps_copy/updaterprps/'?>">
                    <div align="center">
                        ...
                        <div id="myCarousel" class="carousel slide">
                            <div class="carousel-inner">
                                ...
                                <div class="item" align="center">
                                    ...
                                    <textarea class="zzz" name="latar_belakang"><?php foreach ($rpsold as $d): ?><?php echo $d['latar_belakang']; ?><?php endforeach; ?>
                                    </textarea>
                                    <?php foreach ($rpsnew as $d): ?>
                                ...
                                <div class="item">
                                    ...
                                    <table  class="table">
                                        <tr>
                                            ...
                                            <td>: <?php foreach ($rpsold as $d): ?><?php echo $d['nama_matkul']; ?><?php endforeach; ?></td>
                                        </tr>
                                        <tr>
                                            <td width="40%"><b>Kode/SKS</b></td>
                                            <td>: <?php foreach ($rpsold as $d): ?> <?php echo $d['kode_matkul']; ?> / <?php echo $d['sks']; ?><?php endforeach; ?></td>
                                        </tr>
                                        <tr>
                                            <td width="40%"><b>Mata Kuliah Prasyarat</b></td>
                                            <td>: <?php foreach ($rpsold as $d): ?> - <?php endforeach; ?></td>
                                        </tr>
                                        <tr>
                                            <td wdth="40%"><b>Status Mata Kuliah</b></td>
                                            <td>: <?php foreach ($rpsold as $d): ?><?php echo $d['status']; ?><?php endforeach; ?></td>
                                        </tr>
                                    </table>
                                ...
                                <div class="item">
                                        ...
                                        <textarea name="rps_pokok_bahasan" class="zzz"><?php foreach ($rpsold as $d): ?><?php echo $d['pokok_bahasan']; ?><?php endforeach; ?></textarea>
